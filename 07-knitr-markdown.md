...
The key tool for R is [knitr](https://yihui.name/knitr/), which allows
...
[LaTeX](https://www.latex-project.org/), you'll be glad to know that
...
<img src="fig/07-knitr-markdown-rendered-rmd_to_html_fig-1.png" style="display: block; margin: auto auto auto 0;" />
...
function in the [broman](https://github.com/kbroman/broman) package handles
this.
...
- [R Markdown cheat sheet](https://github.com/rstudio/cheatsheets/raw/master/rmarkdown-2.0.pdf) (PDF)
