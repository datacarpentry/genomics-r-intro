...
`/home/dcuser/dc_sample_data/R`. Call this data `variants`. The
...
This isn't a particularly pretty example of a plot. We'll be learning much more about creating
nice, publication-quality graphics later in this lesson. For now, let's explore how we can order
