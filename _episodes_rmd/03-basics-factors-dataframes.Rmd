...
We will use  head() and tail() functions to display first and last 6 rows respectively.
The functions are important in giving us an idea of our data structure.
```{r, echo = FALSE, eval = TRUE, purl = FALSE}
## returns first 6 rows of the data
head(variants)

## returns last 6 rows of the data
tail(variants)

## Determining the rows and columns of the data
dim(variants)
```
