...
- **Console/Terminal**: This is actually where you see the execution of
  ...
  "Terminal" tab gives you access to the BASH terminal (the Linux operating
...
First, let's see what directory we are in. To do so, type the following command
into the script:
...
> ## Tip: Never use `setwd()`
>
> Wait, what were the last 2 minutes about? Well, setting your working directory
