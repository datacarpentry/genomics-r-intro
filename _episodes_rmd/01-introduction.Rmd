...
- **Console/Terminal**: This is actually where you see the execution of
  ...
  system, unrelated to R) - we will not be using this tab.
...
```{r}
# This will round a number to the nearest whole number
round(3.14)
```
...
online search results in the "Help" tab. Finally, if you think there
