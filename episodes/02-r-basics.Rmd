...
- "Understand that vectors have modes, which correspond to the types of data they
  contain"
...
- "Understand that lists can hold data of more than one mode/type and can be indexed"
keypoints:
...
> out. Either way, paying attention to these warnings would help you avoid mistakes.
...
>
> **1) What data types/modes are the following vectors? Use `typeof()` to check**
>
>    a. `snps`
>
>    b. `snp_chromosomes`
...
>
>   **Check the data type/storage mode of `combined` using `typeof()`**
>
>> ## Solution
>>
>> **1) What data types are the following vectors? Use `typeof()` to check**
>>
...
list is that unlike a vector, a list may contain data of more than one class.
